...
const StaticFixedLeftHeader = () => {
  return (
    <>
      ...
      <div className="fixed-header__wrapper position-fixed top-0 bottom-0 h-100 h-fill justify-content-between align-items-align-items-stretch d-xl-flex flex-column text-center">
